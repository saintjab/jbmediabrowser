...
import com.biplio.jbmediabrowser.utils.CURRENT_WINDOW
import com.biplio.jbmediabrowser.utils.PLAYBACK_POS
...
class VideoActivity : JBMediaBaseActivity(){
    ...
    private fun initializePlayer() {
        ...
        if (videoUrl != null) {
            ...
            currentWindow = intent.getIntExtra(CURRENT_WINDOW, 0)
            playbackPosition = intent.getLongExtra(PLAYBACK_POS, 0)
